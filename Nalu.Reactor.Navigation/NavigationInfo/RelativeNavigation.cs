...
public partial class RelativeNavigation : Navigation, IRelativeNavigationInitialBuilder, IRelativeNavigationBuilder, IRelativeNavigationPushOnlyBuilder
{
    ...
    /// </summary>
    public RelativeNavigation() : base(false, default) { }
    ...
    public RelativeNavigation(NavigationBehavior? behavior) : base(false, behavior) { }
    ...
    /// <inheritdoc cref="IRelativeNavigationBuilder.WithPropsDelegate" />
