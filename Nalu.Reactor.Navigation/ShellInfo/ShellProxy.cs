...
internal partial class ShellProxy : IShellProxy, IDisposable
{
    ...
    public ShellProxy(NaluShell shell, IServiceProvider serviceProvider)
    {
        _shell = shell;
    ...
    public Task SelectContentAsync(string segmentName)
    {
        ...
        _navigationTarget = contentProxy.Parent.GetNavigationStack(_serviceProvider, contentProxy).LastOrDefault()?.Route
